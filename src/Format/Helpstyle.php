...
use Sypets\OsbibxParser\Create\Messages;
use Sypets\OsbibxParser\Create\Misc;
 ...
 *
 * @todo requires core/ classes, requires TEMPLATE class which does not exist here
 *   => extract into separate package or remove
